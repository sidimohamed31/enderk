...
export function normalizeProject(project) {
  ...
  return {
    id: project.id,
    title: project.title,
    titleFr: project.title_fr || null,
    titleEn: project.title_en || null,
    regionId: project.region_id,
    mouqataa: project.mouqataa || '',
    category: project.category,
    categoryFr: project.category_fr || null,
    categoryEn: project.category_en || null,
    description: project.description,
    descriptionFr: project.description_fr || null,
    descriptionEn: project.description_en || null,
    impact: project.impact,
    impactFr: project.impact_fr || null,
    impactEn: project.impact_en || null,
